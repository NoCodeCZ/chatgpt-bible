...
- **High-level structure**
  ...
  - **`lib/`**:
    ...
    - `lib/services/` & `lib/hooks/`: feature-specific services and hooks (follow existing filename patterns). See [Service Functions Guide](reference/service-functions-guide.md) and [Custom Hooks Guide](reference/custom-hooks-guide.md).
  - **`types/`**: shared TypeScript types (`Prompt`, `Category`, `Navigation`, `blocks` types). See [TypeScript Types Guide](reference/typescript-types-guide.md).
  - **`scripts/`**: Node-based migration and data utilities targeting Directus. See [Migration Scripts Guide](reference/migration-scripts-guide.md).
  - **`reference/`**: On-demand reference guides with step-by-step instructions for essential development tasks. See [Reference Guides README](reference/README.md).
...
- **[Service Functions Guide](reference/service-functions-guide.md)** - Creating Directus service functions
- **[React Components Guide](reference/react-components-guide.md)** - Creating Server/Client components
- **[Custom Hooks Guide](reference/custom-hooks-guide.md)** - Creating SWR hooks and UI state hooks
- **[TypeScript Types Guide](reference/typescript-types-guide.md)** - Defining types for Directus collections
- **[App Router Pages Guide](reference/app-router-pages-guide.md)** - Creating Next.js pages with metadata/static generation
- **[API Routes Guide](reference/api-routes-guide.md)** - Creating serverless API routes
- **[Migration Scripts Guide](reference/migration-scripts-guide.md)** - Creating Directus migration scripts
- **[HTML to Next.js + Directus Guide](reference/html-to-nextjs-directus-guide.md)** - Converting HTML files to Next.js components and integrating with Directus
- **[Directus + Next.js Workflow](reference/directus-nextjs-workflow.md)** - Complete workflow for collections, blocks, and components
...
- **Use TypeScript consistently**, adding or updating types in `types/` whenever you introduce new Directus fields or component props. See [TypeScript Types Guide](reference/typescript-types-guide.md).
- **Keep Directus access inside `lib/` and `scripts/`**, not inside React components; UI components should consume typed data passed as props. See [Service Functions Guide](reference/service-functions-guide.md).
...
- **Prefer small, focused components and utilities**, following examples like `PromptCard` and `directus-pages` functions. See [React Components Guide](reference/react-components-guide.md).
- **Respect server vs client component boundaries**, only adding `"use client";` when React hooks or browser APIs are required. See [React Components Guide](reference/react-components-guide.md) and [App Router Pages Guide](reference/app-router-pages-guide.md).
...
- **When integrating new Directus collections or fields**, update service `fields` arrays and TypeScript types together, and keep API contracts explicit. See [Directus + Next.js Workflow](reference/directus-nextjs-workflow.md).
